...
const FeatureCard = ({ title, description, icon, gradientBorder, gradientHover }: FeatureCardProps) => {
  return (
    <Card className={cn(
...
export const RewardSection = () => {
  const features = [
    {
      title: "Curated Games",
      description: "Discover and explore handpicked Starknet games with in-depth reviews, ratings, and personalized recommendations tailored for you.",
    ...
    },
    {
      ...
      description: "Earn tokens, NFTs, and reputation for playing, reviewing, voting, and contributing.",
